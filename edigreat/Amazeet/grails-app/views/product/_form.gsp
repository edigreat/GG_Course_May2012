...
<div class="fieldcontain ${hasErrors(bean: productInstance, field: 'urlImage', 'error')} ">
	<label for="urlImage">
		<g:message code="product.urlImage.label" default="Url Image" />
		
	</label>
	<g:field type="url" name="urlImage" maxlength="250" value="${productInstance?.urlImage}"/>
</div>
