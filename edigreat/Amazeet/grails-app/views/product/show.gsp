...
<%@ page import="com.synergyj.Product" %>
<!doctype html>
<html>
	<head>
	...
	<body>
		...
		<div id="show-product" class="content scaffold-show" role="main">
			...
			<ol class="property-list product">
				...
				<g:if test="${productInstance?.urlImage}">
				<li class="fieldcontain">
					<span id="urlImage-label" class="property-label"><g:message code="product.urlImage.label" default="Url Image" /></span>
					
						<span class="property-value" aria-labelledby="urlImage-label"><g:fieldValue bean="${productInstance}" field="urlImage"/></span>
